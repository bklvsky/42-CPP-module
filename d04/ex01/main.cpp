...
/*   Updated: 2022/05/05 01:01:41 by dselmy           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	...
	std::cout << std::endl;
	std::cout << "*** test for brain deepcopy from checklist ***" << std::endl;
	std::cout << std::endl;
	Dog	basic;
	{
		std::cout << std::endl;
		std::cout << "*** creating and destroying temp dog ***" << std::endl;
		Dog tmp = basic;
	}
	std::cout << std::endl;
	std::cout << "Original dog still has its brain:" << std::endl;
	std::cout << "First idea in the brain: " << basic.getBrain()->getIdeas()[0] << std::endl;
	std::cout << std::endl;
}
